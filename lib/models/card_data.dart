...
""",
  ...
  BaseDatas(
    ...
    // audioFrontAsset: 'audio/impuls_contoh3_front.mp3',
    // audioBackAsset: 'audio/impuls_contoh3_back.mp3',
  ),
  BaseDatas(
    title: 'Contoh Sehari hari',
    ...
    // audioFrontAsset: 'audio/impuls_contoh4_front.mp3',
    // audioBackAsset: 'audio/impuls_contoh4_back.mp3',
  ),
  BaseDatas(
    ...
    // audioFrontAsset: 'audio/hukum_kekekalan_momentum_front.mp3',
    // audioBackAsset: 'audio/hukum_kekekalan_momentum_back.mp3',
  ),
  BaseDatas(
  ...
  BaseDatas(
    title: 'Jenis Tumbukan: Lenting Sempurna',
  ...
  BaseDatas(
    title: 'Jenis Tumbukan: Lenting Sebagian',
  ...
  BaseDatas(
    title: 'Jenis Tumbukan: Tidak Lenting Sama Sekali',
  ...
  BaseDatas(
    title: 'Contoh Tidak Lenting Sama Sekali',
